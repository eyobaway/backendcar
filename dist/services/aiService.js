...
class AIService {
    ...
    async getPropertyRecommendations(userQuery, properties, contextProperty) {
        let prompt = `
    ...
    async generateMessageDraft(type, propertyContext, lastMessages) {
        const prompt = `
    ...
    async generateAutocomplete(currentText, propertyContext, lastMessages) {
        const prompt = `
    ...
    async generateAdminPerformanceSummary(stats) {
        const prompt = `
    ...
    async getAdminChatResponse(stats, message, history = []) {
        const prompt = `
    ...
    async generateAgentPerformanceSummary(stats) {
        const prompt = `
    ...
    async getAgentChatResponse(stats, message, history = []) {
        const prompt = `

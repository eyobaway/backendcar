...
const aiChatController = __importStar(require("../controllers/aiChatController"));
...
router.get('/agent-summary', authMiddleware_1.authenticate, aiChatController.getAgentAISummary);
router.post('/agent-query', authMiddleware_1.authenticate, aiChatController.handleAgentAIChat);
